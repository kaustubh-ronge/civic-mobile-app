...
// import { ArrowLeft, Building2, Clock, MapPin, Video } from 'lucide-react-native';
...
//   interval = Math.floor(seconds / 86400); // <-- FIXED: Added missing closing parenthesis here
...
//         // Trim ID to ensure no hidden spaces cause 405/404 errors
...
//           {/* FIXED: Replaced formatDistanceToNow with timeAgo */}
//           <Text style={styles.metaText}>{timeAgo(report.createdAt)}</Text>
//           <Building2 size={14} color="#64748b" style={{marginLeft: 15}} />
//           <Text style={styles.metaText}>{report.department?.name || 'General'}</Text>
//         </View>
...
//             <Image key={i} source={{ uri: img.url }} style={styles.galleryImg} />
//           ))}
//           {report.videos?.length > 0 && (
//             <View style={[styles.galleryImg, styles.videoPlaceholder]}>
//               <Video size={32} color="#94a3b8" />
//               <Text style={{color: '#94a3b8', fontSize: 10, marginTop: 5}}>Video Attached</Text>
//             </View>
//           )}
//         </ScrollView>
...
//           <Text style={styles.locationText}>{report.address || report.city?.name || "View on Map"}</Text>
...
//   statusBadge: { backgroundColor: 'rgba(234,88,12,0.1)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(234,88,12,0.2)' },
//   statusText: { color: '#ea580c', fontSize: 12, fontWeight: 'bold' },
...
//   videoPlaceholder: { alignItems: 'center', justifyContent: 'center', borderStyle: 'dashed', borderWidth: 1, borderColor: '#334155' },
...
//   locationText: { color: 'white', flex: 1, marginLeft: 10, fontSize: 16 },
//   openMap: { color: '#ea580c', fontWeight: 'bold' },
